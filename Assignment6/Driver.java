...
class Driver {
  ...
  public static void main(String[] args) {
	try{
		final PrintStream M;
//		M=new PrintStream(new FileOutputStream("C:\\Users\\Zuhaib Ul Zaman\\Desktop\\sphere-8.txt"));
//		System.setOut(M);
		Timer ab=new Timer();
		ab.start();
       	    BufferedReader br = null;
//            br = new BufferedReader(new FileReader(args[0]));
       	    br=new BufferedReader(new FileReader("C:\\Users\\Zuhaib Ul Zaman\\Desktop\\code\\inp.txt"));
		...
		for (Float f : inp) {
			...
			System.out.println("Getting boundary edges");	
			 ...
			 System.out.println(Arrays.toString(boundary_edges));
                        break;
                    case "IS_CONNECTED":
			...
			System.out.println(Arrays.toString(extended_neighbor_triangle));
			break;
			...
			System.out.println(" Finding   EDGE_NEIGHBOR_TRIANGLE ");
			 ...
			 System.out.println(Arrays.toString(edge_neighbors_of_triangle));
                        break;
			...
			System.out.println(" Finding   FACE_NEIGHBORS_OF_POINT ");
			 ...
			 System.out.println(Arrays.toString(face_nbrs));
                        break;
			...
			System.out.println(" Finding   EDGE_NEIGHBORS_OF_POINT ");
			 ...
			 System.out.println(Arrays.toString(edge_nbrs));
                        break;
			...
			System.out.println(" Finding TRIANGLE_NEIGHBOR_OF_EDGE ");
			 ...
			 System.out.println(Arrays.toString(triangle_neighbors));
			break;
			...
			System.out.println(Arrays.toString(centroid_array));
			...
			System.out.println(" Finding CLOSEST_COMPONENTS ");
			  ...
			  System.out.println(Arrays.toString(closest_vertices));
			break;
